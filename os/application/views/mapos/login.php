...
<body>
  ...
  ?></h1>
      ...
      <img src="<?php echo base_url() ?>assets/img/dashboard-animate.svg" class="left-login-image" alt="SASN - Versão: <?= $this->config->item('app_version'); ?>">
    </div>
    <div id="loginbox">
